...
class ExtensionDelegate: NSObject, WKExtensionDelegate {
    ...
    func applicationDidBecomeActive() {
        ...
        notificationCenter.post(name: NSNotification.Name("AimWatchExtensionReactivatedNotification"), object: self)
    }
    ...
    func applicationWillResignActive() {
        ...
        notificationCenter.post(name: NSNotification.Name("AimWatchExtensionDeactivatedNotification"), object: self)
    }
}
