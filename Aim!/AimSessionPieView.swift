//
//  AimSessionPieView.swift
//  Aim!
//
//  Created by Martin Zhang on 2017-07-08.
...
@IBDesignable
class AimSessionPieView: UIView {
    ...
    @IBInspectable var percentageColor: UIColor = UIColor.black
    ...
    func createPie() {
        ...
        if percentageLayer == nil {
            ...
            percentageLayer.font = UIFont(name: "PhosphatePro-Inline", size: 170)
            percentageLayer.frame = CGRect(x: 0, y: 0, width: bounds.size.width, height: percentageLayer.fontSize + 70)
